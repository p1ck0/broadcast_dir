...
func main() {
 ...
 /_/     \___/ /_/   \__,_/   \__, /  
	...
	serversconn = []string{"127.0.0.1:8081"}
                ...
                go func(udpconn net.UDPConn) {
                    for {
						...
						if pack2.Status == true {
							serverstcp[pack2.TCPport] = pack2.Conns
							fmt.Println(serverstcp)
						} else {
							...
							pack2.Status = true
							serverstcp[pack2.MyTCP] = pack2.MyConns
		...
		case com := <-command:
			...
			case connect:
				*/
				...
				//connectServer(splited[1:], <-udpconns)
//			case disconnect:
